...
| Phase | Concepts JS | Durée |
|-------|------------|-------|
| 1. Données | `const`, tableaux, objets, notation point | ~10 min |
| 2. Console | `for...of`, template literals, `if/else`, fonctions | ~15 min |
| 3. Trier | `sort()`, spread `[...]`, callback | ~10 min |
| 4. Rechercher | `filter()`, `includes()`, `toLowerCase()`, early return | ~10 min |
| 5. HTML | `querySelector`, template literals HTML, `forEach` | ~20 min |
| 6. Interactif | `addEventListener`, chaînage, événement `input` | ~10 min |
